...
<header class="header">
    ...
    <div class="cart-item">
            ...
            <img src="imagenes/plantilla #01.png" alt="">
            <div class="content">
                <h3>plantilla #01</h3>
        ...
        <div class="cart-item">
            <span class="fas fa-times"></span>
            <img src="imagenes/plantilla #02.png" alt="">
            <div class="content">
                <h3>plantilla #02</h3>
                <div class="price">$15.99/-</div>
            </div>
        ...
        <div class="cart-item">
            <span class="fas fa-times"></span>
            <img src="imagenes/plantilla #03.png" alt="">
            <div class="content">
                <h3>plantilla #03</h3>
                <div class="price">$15.99/-</div>
            </div>
        ...
        <div class="cart-item">
            <span class="fas fa-times"></span>
            <img src="imagenes/plantilla #04.png" alt="">
            <div class="content">
                <h3>plantilla #04</h3>
                <div class="price">$15.99/-</div>
            </div>
...
<section class="about" id="about">
    ...
    <div class="row">
        ...
        <div class="image">
            <img src="imagenes/imagen de prueba.png" alt="">
        </div>
...
<section class="review" id="review">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <img src="imagenes/quote-img.png" alt="" class="quote">
            <p>plantillas muy buenas, espero sigan publicando nuevas</p>
            <img src="imagenes/" class="user" alt="">
            <h3>Sergio Rueda</h3>
            <div class="stars">
                <i class="fas fa-star"></i>
                <i class="fas fa-star"></i>
...
<section class="blogs" id="blogs">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <div class="image">
                <img src="imagenes/plantillasfondo01.png" alt="">
            </div>
            <div class="content">
        ...
        <div class="box">
            <div class="image">
                <img src="imagenes/plantillasfondo02.png" alt="">
            </div>
            <div class="content">
                <a href="#" class="title">Novedades sobre nuevas plantillas</a>
                <span>by admin / 21st may, 2021</span>
        ...
        <div class="box">
            <div class="image">
                <img src="imagenes/plantillasfondo03.png" alt="">
            </div>
            <div class="content">
                <a href="#" class="title">Novedades sobre nuevas plantillas</a>
                <span>by admin / 21st may, 2021</span>
...
<section class="footer">
    ...
    <div class="credit">created by <span>mr. web designer</span> | all rights reserved</div>
        ...
        $cartItems = array(
            array(
                'img' => 'imagenes/plantilla #01.png',
                'title' => 'plantilla #01',
                'price' => '$15.99/-'
            ),
            array(
                'img' => 'imagenes/plantilla #02.png',
                'title' => 'plantilla #02',
                'price' => '$15.99/-'
            ),
